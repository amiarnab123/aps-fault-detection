...
class DataIngestion:
    ...
    def Initiate_data_Ingestion(self)->artifact_entity.DataIngestionArtifact:
        try:
            ...
            logging.info("create feature store folder if not availaible")
            ...
            logging.info("save train and test as csv file in dataset directory")
            #save train and test as csv file in dataset directory
